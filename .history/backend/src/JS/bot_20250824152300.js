...
const patterns = {
    'jurusanSMK Syafi''i Akrom memiliki 3 jurusan unggulan: 1. TKJ (Teknik Komputer dan Jaringan) 2. RPL (Rekayasa Perangkat Lunak) 3. Multimedia. Mau tahu lebih detail tentang jurusan mana?',
